...
export const accordionItemClassName = [
  "overflow-hidden rounded-[var(--radius-lg)] border border-[var(--color-border-subtle)] bg-[var(--color-surface)]",
...
export const accordionTriggerClassName = [
  "flex flex-1 items-center justify-between gap-[var(--space-inline-sm)] px-[var(--space-inline-md)] py-[var(--space-stack-sm)]",
...
export const accordionPanelClassName = [
  "overflow-hidden text-[length:var(--text-body-small-size)] leading-[var(--text-body-small-line-height)] text-[var(--color-text-secondary)]",
