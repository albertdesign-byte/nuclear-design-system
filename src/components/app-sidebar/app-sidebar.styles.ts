...
export const appSidebarClassName = [
  "group/app-sidebar flex min-h-0 self-stretch shrink-0 flex-col",
...
export const appSidebarLogoClassName = [
  "flex shrink-0 items-center justify-center p-[var(--space-inline-xs)]",
...
export const appSidebarNavClassName = [
  "flex w-full min-h-0 flex-1 flex-col gap-[var(--space-inline-xs)] overflow-y-auto",
...
export const appSidebarNavItemLabelClassName = [
  "hidden truncate text-[length:var(--text-label-size)] font-medium leading-[var(--text-label-line-height)]",
