...
import { commandInputDisabledClassName, commandItemDisabledClassName } from "@/lib/disabled-styles";

export const commandClassName = [
  componentFontFamilyClassName, "flex size-full flex-col overflow-hidden rounded-[var(--radius-lg)] bg-[var(--color-surface-floating)] p-[var(--space-inline-xs)]",
  "text-[var(--color-text-primary)]",
].join(" ");

export const commandDialogContentClassName = [
  componentFontFamilyClassName, "top-1/3 translate-y-0 overflow-hidden rounded-[var(--radius-lg)] p-0 sm:max-w-lg",
].join(" ");
...
export const commandInputClassName = [
  componentFontFamilyClassName, "flex h-[var(--spacing-40)] w-full bg-transparent py-[var(--space-stack-sm)] outline-none",
  "text-[length:var(--text-body-small-size)] leading-[var(--text-body-small-line-height)] text-[var(--color-text-primary)]",
  commandInputDisabledClassName,
].join(" ");
...
export const commandEmptyClassName = [
  componentFontFamilyClassName, "py-[var(--space-stack-lg)] text-center text-[length:var(--text-body-small-size)] text-[var(--color-text-muted)]",
].join(" ");

export const commandGroupClassName = [
  componentFontFamilyClassName, "overflow-hidden p-[var(--space-inline-xs)] text-[var(--color-text-primary)]",
...
export const commandItemClassName = [
  componentFontFamilyClassName, "group/command-item relative flex cursor-default items-center gap-[var(--space-inline-sm)]",
