...
export const timelineCardClassName = [
  componentFontFamilyClassName, "flex w-full flex-col overflow-hidden rounded-[var(--radius-sm)] border border-[var(--color-border-subtle)]",
...
export const timelineCardHeaderVariants = cva(
  [
    componentFontFamilyClassName, "flex min-h-[var(--spacing-40)] items-center justify-between gap-[var(--space-inline-sm)]",
...
export const timelineCardPriorityClassName = [
  componentFontFamilyClassName, "inline-flex shrink-0 items-center rounded-[var(--radius-full)] border border-[var(--color-error-border)]",
...
export const timelineCardTitleClassName = [
  componentFontFamilyClassName, "truncate text-[length:var(--text-body-small-size)] leading-[var(--text-body-small-line-height)]",
...
export const timelineCardAuthorClassName = [
  componentFontFamilyClassName, "max-w-[9.25rem] shrink-0 truncate text-right",
  "text-[length:var(--text-caption-size)] leading-[var(--text-caption-line-height)]",
  "text-[var(--color-text-muted)]",
].join(" ");

export const timelineCardContentClassName = [
  componentFontFamilyClassName, "flex flex-col gap-[var(--space-stack-sm)] p-[var(--space-inline-md)]",
...
export const timelineCardTagClassName = [
  componentFontFamilyClassName, "inline-flex max-w-full items-center gap-[var(--space-inline-xs)] rounded-[var(--radius-full)]",
