...
export const timelineRootClassName = [
  componentFontFamilyClassName, "flex w-full flex-col overflow-hidden rounded-[var(--radius-card)] border border-[var(--color-border-subtle)]",
...
export const timelineHeaderClassName = [
  componentFontFamilyClassName, "grid border-b border-[var(--color-border-subtle)] bg-[var(--color-surface-muted)]/60",
...
export const timelineColumnHeaderClassName = [
  componentFontFamilyClassName, "px-[var(--space-inline-md)] py-[var(--space-stack-sm)] text-center",
...
export const timelineTrackClassName = [
  componentFontFamilyClassName, "flex min-h-full flex-col sm:flex-row",
].join(" ");

export const timelineColumnClassName = [
  componentFontFamilyClassName, "relative flex min-w-0 flex-1 flex-col gap-[var(--space-stack-lg)]",
...
export const timelineRailClassName = [
  componentFontFamilyClassName, "relative hidden shrink-0 sm:block",
  "w-[var(--timeline-rail-width)]",
].join(" ");

export const timelineRailLineClassName = [
  componentFontFamilyClassName, "absolute inset-y-0 left-1/2 w-px -translate-x-1/2",
...
export const timelineEntryMarkerClassName = [
  componentFontFamilyClassName, "flex w-[var(--timeline-rail-width)] shrink-0 items-start pt-[var(--space-stack-xs)]",
].join(" ");
...
export const timelineTimeMarkerClassName = [
  componentFontFamilyClassName, "flex items-center gap-[var(--space-inline-xs)] whitespace-nowrap",
...
export const timelineEventCardSystemLabelClassName = [
  componentFontFamilyClassName, "inline-flex h-5 items-center rounded-[var(--radius-sm)] bg-[var(--color-info-background)] px-[var(--space-inline-xs)]",
  "text-[length:var(--text-caption-size)] font-medium text-[var(--color-info-text)]",
].join(" ");

export const timelineEventCardFooterClassName = [
  componentFontFamilyClassName, "flex flex-wrap gap-[var(--space-inline-xs)]",
].join(" ");
